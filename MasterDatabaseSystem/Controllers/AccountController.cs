...
using MasterDatabaseSystem.Models.AccountViewModels;
using MasterDatabaseSystem.Services;
using MasterDatabaseSystem.Controllers;
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        ApplicationUser user1 = await _userManager.FindByNameAsync(model.Name);
                        await _userManager.AddToRoleAsync(user, model.Name);

                    }

                    return RedirectToAction(nameof(AccountController.RegisterSuccess));
                }
                AddErrors(result);
            }
